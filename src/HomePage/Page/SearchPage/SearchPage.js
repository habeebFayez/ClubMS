...
const SearchPage = ({user,club,isActive ,clubNotifications, allClubs ,isLoading ,categories ,allClubsCategories,allEventsCategories, events}) => {
    ...
    return (
        <div className="homePage-allclubs">
            <div className="menu-sidebar">
                <Sidebar  user={user} allClubs={allClubs} events={events} clubNotifications={clubNotifications} isActive={isActive} club={club}/>
            </div>
