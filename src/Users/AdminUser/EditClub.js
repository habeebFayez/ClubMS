                    ...
                    JSON.stringify(
                        {
                            ...
                            club:{clubID:clickedClub.clubID,clubName, clubDescription, clubCoverPicURL, clubProfilePicURL},
                                ...
                                <div className="input-field-creat-club">
                                    ...
                                    {chooseUser && user&&(user.authority.authorityName==="ROLE_ADMIN")&&
                                        ...
                                        <div className={"search-results-content-studentNumber-creat-club"}>
                                            ...
                                            {!filterdUsers.length>0&&<h5 style={{marginTop:15}}>No Users Found </h5> }
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="profile-image-club">
                                ...
                                <img
                                    ...
                                    src={file ? URL.createObjectURL(file) :
                                        clubProfilePicURL?clubProfilePicURL:"https://as1.ftcdn.net/v2/jpg/03/29/64/56/1000_F_329645688_8ODoJI5NrLeQDi6K16JvR6DhH2gDXpRV.jpg"}
                            ...
                            <div className="profile-image-club">
                                ...
                                <img
                                    ...
                                    onClick={() => openModalForPic(fileCover ? URL.createObjectURL(fileCover)
                                        ...
                                        "https://as1.ftcdn.net/v2/jpg/03/29/64/56/1000_F_329645688_8ODoJI5NrLeQDi6K16JvR6DhH2gDXpRV.jpg")}
